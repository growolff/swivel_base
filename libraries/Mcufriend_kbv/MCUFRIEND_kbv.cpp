...
MCUFRIEND_kbv::MCUFRIEND_kbv():Adafruit_GFX(320, 480)
{
...
#ifdef SUPPORT_1963
	case 0x1963:
        _lcd_capable = AUTO_READINC | MIPI_DCS_REV1 | READ_24BITS | READ_NODUMMY | INVERT_SS | INVERT_RGB;
        // from NHD 5.0" 8-bit
...
#ifdef SUPPORT_8347D
    case 0x4747:
        _lcd_capable = REV_SCREEN | MIPI_DCS_REV1 | MV_AXIS | READ_24BITS | INVERT_SS;
        is8347 = 1;
